    ...
    <>
      ...
      <div className="bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Featured Properties */}
          <section ref={featuredSectionRef} className="py-12 sm:py-20 border-b border-slate-200">
          ...
          {/* Property Types */}
          <section className="py-12 sm:py-20 border-b border-slate-200">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 mb-8 sm:mb-12">Browse by Type</h2>
          ...
          <section className="py-12 sm:py-20">
            <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl sm:rounded-3xl p-6 sm:p-12 lg:p-20">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-2 sm:mb-4 text-center">Why Choose RealEstate?</h2>
              <p className="text-xs sm:text-sm md:text-base text-slate-300 text-center max-w-2xl mx-auto mb-8 sm:mb-16">Trusted by thousands of buyers, sellers, and agents across India</p>
          ...
          {/* Top Agents */}
          <section className="py-12 sm:py-20 border-t border-slate-200">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4 mb-8 sm:mb-12">
              <div className="flex-1 min-w-0">
